...
world.beforeEvents.playerPlaceBlock.subscribe(({ block, player: plr, dimension: dim }) => {
    ...
    if (id == 'minecraft:chest' || id == 'minecraft:trapped_chest') {
        ...
        block.setPermutation(permutation.type.id);
    }
});